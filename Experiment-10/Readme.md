...
CRUD Operations on Database using Node.js and Express.js Backend

 Objective

To design and implement a Node.js application using Express.js for performing CRUD operations on student records stored in MongoDB. The goal is to understand API development, database connectivity, and backend routing.
